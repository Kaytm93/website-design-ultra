...
/**
 * The context-loss observer (IP-05C). The WebGLRenderer already listens for
 * webglcontextlost and calls preventDefault (three r185 re-initializes on
 * restore), so this gate observes and records:
 *
...
export function ContextLossGate({ onContextLost }: ContextLossGateProps) {
  ...
  const { quality, invalidateReady } = useSceneRuntime()
  ...
  }, [gl, quality, invalidateReady, onContextLost])
