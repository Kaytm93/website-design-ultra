import { validateTimelineManifest, evaluateTimeline } from '@wdu-references/cinematic-timeline.ts';

export const LAB_MANIFEST = validateTimelineManifest({
  schemaVersion: 1,
  surface: 'wdu.cinematic-timeline',
  project: 'wdu-lab-cinematic-evidence',
...
export const LAB_EVIDENCE = {
  seek0: evaluateTimeline(LAB_MANIFEST, 0),
  seek050: evaluateTimeline(LAB_MANIFEST, 0.5),
  seek100: evaluateTimeline(LAB_MANIFEST, 1),
  seek050Portrait: evaluateTimeline(LAB_MANIFEST, 0.5, { portrait: true }),
};
