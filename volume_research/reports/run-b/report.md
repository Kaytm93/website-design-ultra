...
|---|---|---|---|---|---|
| slice textures | 16 | 1.55 ms | 0.17 ms | `44dd2bcff586f134…` | 32×32×32 |
| sparse points | 16 | 0.05 ms | 0.03 ms | `7d0f3195c600e594…` | 19611×4 |
...
- Path: `volume_research/reports/run-b/points.glb`
