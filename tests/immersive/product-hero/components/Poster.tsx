...
/**
 * The art-directed 2D fallback (IP-05C pattern). One composed SVG per
 * viewport class, mirroring the live composition — the Orbit One speaker on
 * its base, same palette, same accent light — so the fallback is a
 * composition, never a blank frame. The poster is decorative: text and
 * controls stay in the DOM (3d-art-direction: "Keep text and CTA in the DOM;
 * bake only decorative typography into the poster" — this poster bakes none).
 */
